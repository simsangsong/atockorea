  ...
  return (
    <section ref={heroSectionRef} className="relative flex flex-col" data-home-hero>
      ...
      >
        ...
        <div className="rounded-2xl border border-slate-100 bg-white px-5 py-5 shadow-[0_1px_6px_rgba(15,23,42,0.06)]">
          {/* Trust headline — the primary claim */}
          <h2 className="mb-2 text-[17px] font-bold leading-snug tracking-[-0.02em] text-slate-900 md:text-[18px]">
            Stop searching. We already did it for you.
          </h2>
          <p className="mb-4 text-[13px] leading-relaxed text-slate-500">
            Every tour here is independently verified by us — and already proven by{" "}
          ...
          <div className="grid grid-cols-[auto_auto_1fr] gap-2">
            <div className="rounded-xl border border-slate-100 bg-white/80 px-3.5 py-2.5 shadow-[0_1px_4px_rgba(15,23,42,0.05)]">
              <span className="block text-[17px] font-extrabold leading-none tracking-tight text-slate-900">
                4.9<span className="text-[12px] text-amber-400">★</span>
              </span>
              <span className="mt-1 block text-[9.5px] font-medium text-slate-400">avg. rating</span>
            </div>

            <div className="rounded-xl border border-slate-100 bg-white/80 px-3.5 py-2.5 shadow-[0_1px_4px_rgba(15,23,42,0.05)]">
              <span className="block text-[17px] font-extrabold leading-none tracking-tight text-slate-900">100K+</span>
              <span className="mt-1 block text-[9.5px] font-medium text-slate-400">bookings</span>
            </div>

            <div className="rounded-xl border border-slate-100 bg-white/80 px-3 py-2.5 shadow-[0_1px_4px_rgba(15,23,42,0.05)]">
              <span className="block text-[10.5px] font-semibold leading-tight text-slate-700">
                KLO** · VIA*** · GYG*** · KKD** +4
              </span>
              <span className="mt-1 block text-[9.5px] font-medium text-slate-400">KTO-licensed · verified</span>
            </div>
          </div>
          ...
          <div className="mt-3 flex flex-wrap items-center gap-x-3 gap-y-1.5 border-t border-slate-100 pt-3">
            ...
            <span className="flex items-center gap-1 text-[11px] font-semibold text-emerald-700">
              <span aria-hidden>✓</span> KTO-licensed only
            </span>
          </div>
        </div>
        </div>
