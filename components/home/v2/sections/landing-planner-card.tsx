...
import SelectDropdown from "@/components/itinerary-builder/SelectDropdown";
  ...
  return (
    <div ref={cardRef} className="relative mx-auto max-w-lg">
      <div className="relative rounded-card border border-slate-200/70 bg-white p-4 shadow-1 md:p-5">
        ...
        {/* Seoul re-activated 2026-06-21 — coming-soon gate removed; Seoul now flows
            through the normal matcher/builder body like Jeju/Busan. */}
