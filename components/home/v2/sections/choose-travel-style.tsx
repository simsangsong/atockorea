    ...
    <section className="py-14 md:py-20 px-4 md:px-6 bg-gradient-to-b from-slate-50/80 to-white">
      <div ref={containerRef} className="max-w-4xl mx-auto">
        <div className="text-center mb-10 md:mb-14">
          ...
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-slate-800 tracking-tight mb-3">Three ways to explore</h2>
          <p className="text-slate-600 text-[14px] md:text-[15px] font-medium max-w-lg mx-auto leading-relaxed">
            We recommend small group for most travelers, with private and traditional bus as strong alternatives
          ...
          <div className="relative bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.12)] p-6 md:p-8 overflow-hidden border border-slate-700/50">
            ...
            <div className="relative">
              <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-5 md:gap-6 mb-6 md:mb-8">
                <div>
                  <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-2">Small Group Tour</h3>
              ...
              <V0ShadcnButton
                asChild
                size="lg"
                className="w-full bg-white hover:bg-white/95 text-slate-900 font-semibold py-5 md:py-6 rounded-xl text-[13px] md:text-sm shadow-[0_4px_16px_rgba(0,0,0,0.2)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.25)] transition-all duration-300 h-auto"
              >
                <Link
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div
            className="group bg-white rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.06)] border border-slate-200/70 p-5 md:p-6 hover:shadow-[0_8px_28px_rgba(0,0,0,0.09)] hover:border-slate-300 transition-all duration-300 relative overflow-hidden scroll-animate"
            data-animate
          >
            ...
            <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-1">Private Tour</h3>
            <div className="mb-3">
          ...
          >
            ...
            <h3 className="text-lg md:text-xl font-bold text-slate-800 tracking-tight mb-1.5">Traditional Bus Tour</h3>
