...
const SLUG_OVERRIDES: Record<string, SlugOverride> = {
  ...
  "busan-plum-cherry-blossom-day-tour-to-yangsan-gyeongju": { listPriceUsd: 52, compareAtPriceUsd: 58, maxGroupSize: 8 },
  "busan-small-group-sightseeing-tour-cruise-passengers": { listPriceUsd: 79, compareAtPriceUsd: 85, maxGroupSize: 8 },
  "busan-spring-cherry-blossom-gyeongju-highlights-day-tour": { listPriceUsd: 52, compareAtPriceUsd: 58, maxGroupSize: 8 },
