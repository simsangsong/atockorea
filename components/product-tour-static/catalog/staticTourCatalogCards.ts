...
const SLUG_OVERRIDES: Record<string, SlugOverride> = {
  ...
  "jeju-grand-highlights-loop": { listPriceUsd: 88, compareAtPriceUsd: 112, maxGroupSize: 8 },
  ...
  "jeju-cruise-shore-excursion-small-group-tour": { listPriceUsd: 72, compareAtPriceUsd: 85, maxGroupSize: 8 },
