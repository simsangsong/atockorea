...
import { jejuGrandHighlightsLoopDetailViewModel as staticVm } from "./jejuGrandHighlightsLoopDetailViewModel";
...
/** east-signature / southwest와 동일 레이아웃; 환도 하이라이트 루프 데이터. */
