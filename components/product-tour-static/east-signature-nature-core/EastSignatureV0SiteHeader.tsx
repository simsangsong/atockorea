...
/** TourDetailV2 `site-header.tsx`와 동일 마크업·클래스 (공용 `Button`만 사용, 구 booking 아님). */
export function EastSignatureV0SiteHeader() {
  return (
        ...
        <div className="flex h-14 items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <Button
              variant="ghost"
              size="icon"
              className="h-9 w-9 min-w-9 text-muted-foreground hover:text-foreground hover:bg-muted/60 transition-colors"
            >
