...
export type GlanceItem = {
  label: string;
  value: string;
  icon: "camera" | "mountain" | "footprints" | "cloud-rain" | "users" | "scale";
};
...
export const reviewsSummary = {
  averageRating: eastSignatureNatureCoreStaticProduct.rating,
  totalReviews: eastSignatureNatureCoreStaticProduct.reviewCount,
  ratingDistribution: [
