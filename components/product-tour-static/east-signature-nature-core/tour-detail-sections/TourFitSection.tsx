          ...
          {lessIdealItems.length > 0 && (
            <div className="mt-3 border-t border-slate-200/60 pt-3">
              ...
              >
                ...
                <ChevronDown
                  className={cn(
                    "h-4 w-4 flex-shrink-0 text-muted-foreground/60 transition-transform duration-200",
