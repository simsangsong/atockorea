...
> = {
  ...
  it: { start: 'Avvia sottotitoli in diretta', stop: 'Stop', live: 'Sottotitoli in onda', record: 'Salva trascrizione', denied: 'Il microfono è bloccato — consentilo nelle impostazioni del browser.' },
};
