...
> = {
  ...
  'zh-TW': {
    transcribing: '正在聽寫…',
    confirmHint: '請確認內容後再傳送',
    micDenied: '麥克風被封鎖 — 請在瀏覽器設定中允許。',
    sttFailed: '沒有聽清楚 — 請再試一次。',
    cancel: '取消',
    done: '完成',
  },
  fr: {
...
> = {
  ...
  'zh-TW': { caption: '新增說明（選填）', send: '傳送', sending: '傳送中…', cancel: '取消', tooBig: '檔案太大了。' },
      ...
      <div className="tr-chiprow mb-1.5 flex gap-1.5 px-3 pb-1" data-testid="quick-replies">
        {quickRepliesForRole(viewerRole).map((preset) => (
          <button
            ...
            className="tr-label tr-chip-tap tr-chip-tap--quiet shrink-0 rounded-full bg-[var(--tr-chip-quiet-fill)] px-3.5 py-2 font-medium text-[var(--tr-ink-2)]"
          >
