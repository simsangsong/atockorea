...
export const ENTRY_COPY: Record<RoomLocale, EntryCopy> = {
  ...
  fr: {
    ...
    guestHint: 'Réservé en tant qu’invité? Saisissez votre numéro de réservation et l’e-mail utilisé.',
    bookingIdLabel: 'Numéro de réservation',
    emailLabel: 'E-mail utilisé pour la réservation',
    ...
    errorNotFound: 'Aucune réservation trouvée avec ces informations.',
  },
  de: {
    title: 'Tour-Modus',
    ...
    guestHint: 'Als Gast gebucht? Geben Sie Ihre Buchungsnummer und die verwendete E-Mail-Adresse ein.',
    bookingIdLabel: 'Buchungsnummer',
    emailLabel: 'E-Mail der Buchung',
    nameLabel: 'Name (optional)',
    ...
    errorNotFound: 'Keine Buchung mit diesen Angaben gefunden.',
  },
  ru: {
    title: 'Режим тура',
    ...
    guestHint: 'Бронировали как гость? Введите номер бронирования и почту, которую использовали.',
    bookingIdLabel: 'Номер бронирования',
    emailLabel: 'Почта, указанная при бронировании',
    ...
    errorNotFound: 'Бронирование с такими данными не найдено.',
  },
  it: {
    title: 'Modalità Tour',
    ...
    guestHint: 'Hai prenotato come ospite? Inserisci l’ID di prenotazione e l’e-mail che hai usato.',
    bookingIdLabel: 'ID prenotazione',
    emailLabel: 'E-mail usata per la prenotazione',
    ...
    errorNotFound: 'Nessuna prenotazione trovata con questi dati.',
  },
};
