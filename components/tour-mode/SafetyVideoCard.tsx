...
import { IconOpsBadge, IconPlay, TR_ICON, TR_STROKE } from '@/components/tour-mode/icons';
        ...
        >
          {meta.poster_url ? (
            ...
            <div className="flex aspect-[9/16] max-h-[420px] w-full items-center justify-center bg-[var(--tr-surface-2)] text-[var(--tr-ink-3)]">
              <IconOpsBadge size={TR_ICON.tile} strokeWidth={TR_STROKE.default} aria-hidden />
            </div>
          )}
