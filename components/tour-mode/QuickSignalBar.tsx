...
> = {
  ...
  'zh-TW': {
    ...
    rest: '🚻 想停一下',
    lost: '🧭 我迷路了',
    lostConfirm: '要將目前位置分享給導遊一次嗎？',
    sent: '已傳送給導遊 ✓',
    failed: '未能傳送——請在下方聊天告訴導遊。',
    pickup: '🚕 來這裡接我',
    pickupConfirm: '分享一次目前位置，讓司機來接您？',
    drop: '📍 更改下車點',
    dropPrompt: '您想在哪裡下車？（地點名稱）',
    ok: '分享',
    cancel: '取消',
    meet: '📍 在這裡會合',
    meetConfirm: '傳送您的精確位置，讓司機直接導航到您身邊？',
    photoAsk: '加拍一張眼前的照片',
    photoCaption: '📍 這是我現在看到的景色',
    skip: '略過',
  },
  fr: {
