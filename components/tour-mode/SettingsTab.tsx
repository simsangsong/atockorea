...
const LOCALE_NAME: Record<RoomLocale, string> = {
  ...
  ja: '日本語',
  es: 'Español',
  // Both Chinese scripts are offered now, so each button names its script.
  zh: '简体中文',
  'zh-TW': '繁體中文',
  fr: 'Français',
  de: 'Deutsch',
...
const COPY: Record<RoomLocale, SettingsCopy> = {
  en: {
    ...
    autoRead: 'Read notices & stops aloud',
    autoReadHint: 'Announcements and each stop’s guide are spoken in your language (screen must stay on).',
    textSize: 'Text size',
    textNormal: 'Normal',
    textLarge: 'Large',
    close: 'Close',
  ...
  ko: {
    ...
    autoRead: '안내·스팟 해설 소리로 읽기',
    autoReadHint: '가이드 공지와 스팟 도착 해설을 내 언어로 읽어 줍니다 (화면이 켜져 있어야 해요).',
    textSize: '글자 크기',
    textNormal: '보통',
    textLarge: '크게',
    close: '닫기',
  ...
  ja: {
    ...
    autoRead: 'お知らせ・スポット解説を読み上げ',
    autoReadHint: 'ガイドのお知らせと各スポットの解説をあなたの言語で読み上げます（画面オンが必要）。',
    textSize: '文字サイズ',
    textNormal: '標準',
    textLarge: '大きい',
    close: '閉じる',
  ...
  es: {
    ...
    autoRead: 'Leer avisos y paradas en voz alta',
    autoReadHint: 'Los avisos y la guía de cada parada se leen en tu idioma (la pantalla debe estar encendida).',
  ...
  zh: {
    ...
    autoRead: '朗读通知与景点讲解',
    autoReadHint: '用您的语言朗读导游通知和每个景点的讲解（需保持屏幕常亮）。',
    textSize: '字体大小',
    textNormal: '标准',
    textLarge: '大',
    close: '关闭',
  ...
  'zh-TW': {
    language: '語言',
    appLanguage: 'App 語言',
    appLanguageHint: '介面與通知使用的語言',
    chatLanguage: '聊天語言',
    chatLanguageHint: '導遊和司機的訊息會以這個語言顯示。',
    chatAuto: '自動（依我的輸入）',
    theme: '顯示模式',
    skin: '背景主題',
    themeLight: '淺色',
    themeDark: '深色',
    themeSystem: '自動',
    voiceConfirm: '傳送前確認語音文字',
    voiceConfirmHint: '說話內容轉成文字後，先確認、修改再傳送。',
    autoRead: '朗讀通知與景點解說',
    autoReadHint: '以您的語言朗讀導遊通知和每個景點的解說（螢幕需保持開啟）。',
    textSize: '文字大小',
    textNormal: '標準',
    textLarge: '大',
    close: '關閉',
  ...
  fr: {
    ...
    autoRead: 'Lire les annonces et les étapes à voix haute',
    autoReadHint: 'Les annonces et le commentaire de chaque étape sont lus dans votre langue (l’écran doit rester allumé).',
  ...
  de: {
    ...
    autoRead: 'Ansagen & Stopps vorlesen',
    autoReadHint: 'Ansagen und die Erklärung zu jedem Stopp werden in Ihrer Sprache vorgelesen (Bildschirm muss an bleiben).',
    textSize: 'Textgröße',
    textNormal: 'Normal',
    textLarge: 'Groß',
    close: 'Schließen',
  ...
  ru: {
    ...
    autoRead: 'Озвучивать объявления и остановки',
    autoReadHint: 'Объявления гида и рассказ о каждой остановке читаются вслух на вашем языке (экран должен быть включен).',
  ...
  it: {
    ...
    autoRead: 'Leggi ad alta voce avvisi e tappe',
    autoReadHint: 'Gli avvisi e il racconto di ogni tappa vengono letti nella tua lingua (lo schermo deve restare acceso).',
