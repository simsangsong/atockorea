...
export function RecommendationsSection() {
  return (
    <div className="space-y-6">
      <div className="px-5">
        <p className="text-[10px] font-semibold text-primary tracking-wide">Explore next</p>
        <h2 className="text-lg font-semibold text-foreground tracking-tight mt-1">
          You might also like
        </h2>
        <p className="mt-1.5 text-sm text-muted-foreground leading-relaxed">
          Different pacing, different emphasis. Each is its own day.
        </p>
      </div>
      
      {/* Horizontal Swipeable Carousel - Aspirational premium cards */}
      <div 
            ...
            <div className="p-4 pb-5">
              ...
              <div className="mt-3.5 flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <span className="text-base font-semibold text-foreground">{rec.price}<span className="text-[10px] font-normal text-muted-foreground ml-0.5">KRW</span></span>
                </div>
              </div>
            </div>
          </a>
