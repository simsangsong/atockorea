      ...
      <div className="container mx-auto px-4 py-3 md:py-0 md:px-0">
        <div className="flex gap-3 md:flex-col md:gap-2">
          ...
          <button
            ...
            className="flex-1 md:w-full px-6 py-4 md:py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold rounded-lg transition-all duration-200 shadow-md hover:shadow-lg text-center min-h-[44px] flex items-center justify-center"
          >
            Check Availability
          </button>
          ...
          <button
            ...
            className="px-4 py-4 md:py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center md:w-full"
          ...
          >
            ...
            <span className="ml-2 md:hidden">Wishlist</span>
          </button>
