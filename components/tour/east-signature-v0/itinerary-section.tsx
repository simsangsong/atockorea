...
const stops: Stop[] = [
  ...
  },
  {
    ...
    description: "This is the main volcanic highlight of the day. Seongsan brings together crater scenery, coastal scale, and—depending on timing—the haenyeo show context that makes the stop feel even more distinctly Jeju.",
    ...
    whyOnRoute: "After lunch, Seongsan becomes the natural main event of the day—active, scenic, and culturally distinct.",
    visitBasics: {
...
function StopCard({ stop, isExpanded, onToggle }: { stop: Stop; isExpanded: boolean; onToggle: () => void }) {
  return (
