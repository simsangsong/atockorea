    ...
    <section className="relative w-full">
      ...
      <div className="relative h-[52vh] min-h-[400px] max-h-[520px] sm:h-[58vh] sm:min-h-[460px] sm:max-h-[600px] w-full overflow-hidden rounded-b-2xl shadow-hero">
        ...
        <div 
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1596402184320-417e7178b2cd?w=1920&q=80')`,
                ...
                <div className="ml-auto flex items-center gap-1.5 sm:gap-2">
                  <div className="flex items-center gap-0.5">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <Star 
                        key={star} 
                        className={`h-2.5 w-2.5 sm:h-3 sm:w-3 ${star <= 4 ? 'fill-amber-400 text-amber-400' : 'fill-white/30 text-white/30'}`} 
                      />
                    ))}
                  </div>
                  <span className="text-[13px] sm:text-sm font-semibold text-white">4.8</span>
                </div>
              </div>
            </div>
          </div>
