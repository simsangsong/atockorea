...
**상태:** Wave T0 완료 + Wave T1 진행 중(T1.1~T1.5 완료 — join/snapshot API, D-8 로케일 타게팅+Broadcast+원문 선게시, 진입/룸 페이지, Realtime 채널 훅. 테스트 126개). **T0.3 라이브 DDL만 사용자 승인 대기.** 다음 = T1.6.
