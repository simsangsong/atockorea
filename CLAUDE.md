...
**상태:** Wave U0~U8 전체 구현 완료(2026-07-15) — 토큰 시스템·메신저 레이아웃·버블 시스템·컴포저·카드 리스킨·탭 개편 머지 대기. 투어룸 테스트 228개 green(신규 17개 포함), 기능·API·lib 로직 변경 0건. 잔여 파킹 항목은 플랜 §L 참조(지도 마커 아이콘화·탭 크로스페이드·읽음표시 백로그).
