...
export const CONCIERGE_CHIPS: ReadonlyArray<{ intent: ConciergeIntent; label: Record<RoomLocale, string> }> = [
  {
    intent: 'restroom',
    label: { en: 'Restroom', ko: '화장실', ja: 'トイレ', es: 'Baños', zh: '洗手间', fr: 'Toilettes', de: 'Toilette', ru: 'Туалет', it: 'Bagno' },
  },
  {
    intent: 'photo_spot',
    label: { en: 'Photo spot', ko: '포토스팟', ja: '写真スポット', es: 'Mejor foto', zh: '拍照点', fr: 'Spot photo', de: 'Fotospot', ru: 'Фотоспот', it: 'Punto foto' },
  },
  {
    intent: 'restaurant',
    label: { en: 'Food nearby', ko: '맛집', ja: '近くの店', es: 'Comer cerca', zh: '附近餐厅', fr: 'Où manger', de: 'Essen in der Nähe', ru: 'Где поесть', it: 'Dove mangiare' },
  },
  {
    intent: 'next_stop',
    label: { en: 'Next stop', ko: '다음 일정', ja: '次の予定', es: 'Siguiente parada', zh: '下一站', fr: 'Prochaine étape', de: 'Nächster Stopp', ru: 'Куда дальше', it: 'Prossima tappa' },
  },
  {
    intent: 'time_left',
    label: { en: 'Time left', ko: '남은 시간', ja: '残り時間', es: 'Tiempo restante', zh: '剩余时间', fr: 'Temps restant', de: 'Restzeit', ru: 'Сколько осталось', it: 'Tempo rimasto' },
  },
];
