...
const JOIN_LINES: Array<Record<RoomLocale, string>> = [
  ...
  },
  {
    ...
    'zh-TW': '這個聊天室會自動翻譯 — 用您的語言輸入，工作人員就能看懂。',
  ...
  },
  {
    ...
    'zh-TW': '今日路線在行程分頁。每到一站，我們都會在這裡傳送集合時間、洗手間地圖和迷你導覽。',
  ...
  },
  {
    ...
    'zh-TW': '集合時間會一直顯示在螢幕頂端並倒數 — 請開啟通知，並提早一點回來。🙏',
...
const PRIVATE_LINES: Array<Record<RoomLocale, string>> = [
  {
    ...
    'zh-TW': '早安！我是今天的司機。這個聊天室會自動翻譯，請放心用您的語言交流。🚐',
  ...
  },
  {
    ...
    'zh-TW': '路線只往單一方向行進 — 無法來回繞路，出發前我們會確認遊覽順序。',
  ...
  },
  {
    ...
    'zh-TW': '有問題隨時問 — 在這裡傳送文字、照片或語音，都會立即以韓語傳達給我。',
