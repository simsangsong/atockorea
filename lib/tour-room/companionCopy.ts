...
const COPY: Record<CompanionCopyKey, Record<RoomLocale, string>> = {
  ...
  joinHint: {
    ...
    'zh-TW': '這台裝置會在旅遊房間中擁有自己的位置：自己的聊天與自己的報到。',
  ...
  nameLabel: { en: 'Your name', ko: '이름', ja: 'お名前', es: 'Tu nombre', zh: '您的姓名', 'zh-TW': '您的姓名', fr: 'Votre nom', de: 'Ihr Name', ru: 'Имя', it: 'Il tuo nome' },
  namePlaceholder: { en: 'e.g. Sofia', ko: '예: 지민', ja: '例: さくら', es: 'p. ej. Sofía', zh: '例：小明', 'zh-TW': '例：怡君', fr: 'ex. Léa', de: 'z. B. Lena', ru: 'например, Анна', it: 'es. Giulia' },
  joinCta: { en: 'Join the room', ko: '투어룸 입장', ja: 'ルームに参加', es: 'Entrar a la sala', zh: '进入房间', 'zh-TW': '進入旅遊房間', fr: 'Rejoindre l’espace tour', de: 'Tour-Raum beitreten', ru: 'Войти в комнату тура', it: 'Entra nella stanza' },
  joining: { en: 'Joining…', ko: '입장 중…', ja: '参加中…', es: 'Entrando…', zh: '正在加入…', 'zh-TW': '加入中…', fr: 'Connexion…', de: 'Beitritt läuft…', ru: 'Подключение…', it: 'Ingresso in corso…' },
  joinedTitle: { en: 'You are in', ko: '등록됐어요', ja: '参加しました', es: 'Ya estás dentro', zh: '已加入', 'zh-TW': '您已加入', fr: 'Vous y êtes', de: 'Sie sind dabei', ru: 'Готово — вы в комнате', it: 'Sei dentro' },
  joinedHint: {
  ...
  openRoom: { en: 'Open the room', ko: '투어룸 열기', ja: 'ルームを開く', es: 'Abrir la sala', zh: '打开房间', 'zh-TW': '開啟旅遊房間', fr: 'Ouvrir l’espace tour', de: 'Tour-Raum öffnen', ru: 'Открыть комнату', it: 'Apri la stanza' },
  full: {
  ...
  retry: { en: 'Try again', ko: '다시 시도', ja: 'もう一度', es: 'Reintentar', zh: '重试', 'zh-TW': '再試一次', fr: 'Réessayer', de: 'Erneut versuchen', ru: 'Повторить', it: 'Riprova' },
  ...
  inviteHint: {
    ...
    'zh-TW': '分享連結，讓同行的人可以用自己的手機使用旅遊房間。',
  ...
  inviteCta: { en: 'Create invite link', ko: '초대 링크 만들기', ja: '招待リンクを作成', es: 'Crear enlace', zh: '生成邀请链接', 'zh-TW': '建立邀請連結', fr: 'Créer un lien d’invitation', de: 'Einladungslink erstellen', ru: 'Создать ссылку-приглашение', it: 'Crea link d’invito' },
  inviteSlots: {
    ...
    'zh-TW': '{capacity} 台中還剩 {remaining} 台',
  ...
  copy: { en: 'Copy link', ko: '링크 복사', ja: 'リンクをコピー', es: 'Copiar enlace', zh: '复制链接', 'zh-TW': '複製連結', fr: 'Copier le lien', de: 'Link kopieren', ru: 'Скопировать ссылку', it: 'Copia link' },
  copied: { en: 'Copied', ko: '복사됨', ja: 'コピーしました', es: 'Copiado', zh: '已复制', 'zh-TW': '已複製', fr: 'Copié', de: 'Kopiert', ru: 'Скопировано', it: 'Copiato' },
  share: { en: 'Share', ko: '공유', ja: '共有', es: 'Compartir', zh: '分享', 'zh-TW': '分享', fr: 'Partager', de: 'Teilen', ru: 'Поделиться', it: 'Condividi' },
  inviteExpiry: {
...
export function detectCompanionLocale(raw?: string | null): RoomLocale {
  ...
  return normalizeRoomLocale(raw ?? (typeof window !== 'undefined' ? navigator.language : 'en'), 'en');
}
