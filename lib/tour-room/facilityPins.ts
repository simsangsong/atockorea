...
const KIND_DEFAULT_LABEL: Record<FacilityKind, Record<RoomLocale, string>> = {
  restroom: { en: 'Restroom', ko: '화장실', zh: '洗手间', 'zh-TW': '洗手間', ja: 'トイレ', es: 'Baño', fr: 'Toilettes', de: 'Toilette', ru: 'Туалет', it: 'Bagno' },
  photo: { en: 'Photo spot', ko: '포토스팟', zh: '拍照点', 'zh-TW': '拍照點', ja: '写真スポット', es: 'Foto', fr: 'Spot photo', de: 'Fotospot', ru: 'Фотоспот', it: 'Punto foto' },
  restaurant: { en: 'Restaurant', ko: '맛집', zh: '餐厅', 'zh-TW': '餐廳', ja: 'レストラン', es: 'Restaurante', fr: 'Restaurant', de: 'Restaurant', ru: 'Ресторан', it: 'Ristorante' },
  ticket_booth: { en: 'Ticket booth', ko: '매표소', zh: '售票处', 'zh-TW': '售票處', ja: 'チケット売り場', es: 'Taquilla', fr: 'Billetterie', de: 'Ticketschalter', ru: 'Касса', it: 'Biglietteria' },
};
