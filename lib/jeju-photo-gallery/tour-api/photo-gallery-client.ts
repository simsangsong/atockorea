/**
 * Tour API — PhotoGalleryService1 (관광사진). Request construction isolated for tests.
 */

import { extractXmlStyleErrorMessage } from './parser';
...
export class JejuPhotoGalleryTourApiClient {
