...
export const DIETARY_LABELS: Record<DietaryFilterTag, Record<RoomLocale, string>> = {
  vegetarian: { en: 'Vegetarian', ko: '채식', ja: 'ベジタリアン', es: 'Vegetariano', zh: '素食', 'zh-TW': '素食', fr: 'Végétarien', de: 'Vegetarisch', ru: 'Вегетарианское', it: 'Vegetariano' },
  vegan: { en: 'Vegan', ko: '비건', ja: 'ヴィーガン', es: 'Vegano', zh: '纯素', 'zh-TW': '純素', fr: 'Végétalien', de: 'Vegan', ru: 'Веганское', it: 'Vegano' },
  halal: { en: 'Halal', ko: '할랄', ja: 'ハラル', es: 'Halal', zh: '清真', 'zh-TW': '清真', fr: 'Halal', de: 'Halal', ru: 'Халяль', it: 'Halal' },
  no_pork: { en: 'No pork', ko: '돼지고기 제외', ja: '豚肉なし', es: 'Sin cerdo', zh: '不含猪肉', 'zh-TW': '不含豬肉', fr: 'Sans porc', de: 'Ohne Schweinefleisch', ru: 'Без свинины', it: 'Senza maiale' },
  no_seafood: { en: 'No seafood', ko: '해산물 제외', ja: '魚介類なし', es: 'Sin mariscos', zh: '不含海鲜', 'zh-TW': '不含海鮮', fr: 'Sans fruits de mer', de: 'Ohne Meeresfrüchte', ru: 'Без морепродуктов', it: 'Senza frutti di mare' },
  no_shellfish: { en: 'No shellfish', ko: '조개·갑각류 제외', ja: '貝・甲殻類なし', es: 'Sin crustáceos', zh: '不含贝类', 'zh-TW': '不含貝類', fr: 'Sans crustacés', de: 'Ohne Schalentiere', ru: 'Без моллюсков и ракообразных', it: 'Senza crostacei' },
  no_nuts: { en: 'No nuts', ko: '견과류 제외', ja: 'ナッツなし', es: 'Sin frutos secos', zh: '不含坚果', 'zh-TW': '不含堅果', fr: 'Sans fruits à coque', de: 'Ohne Nüsse', ru: 'Без орехов', it: 'Senza frutta a guscio' },
  gluten_free: { en: 'Gluten-free', ko: '글루텐 프리', ja: 'グルテンフリー', es: 'Sin gluten', zh: '无麸质', 'zh-TW': '無麩質', fr: 'Sans gluten', de: 'Glutenfrei', ru: 'Без глютена', it: 'Senza glutine' },
  kids: { en: 'Kid-friendly', ko: '아이 동반', ja: '子ども連れ', es: 'Para niños', zh: '适合儿童', 'zh-TW': '適合兒童', fr: 'Adapté aux enfants', de: 'Kinderfreundlich', ru: 'Подходит для детей', it: 'Adatto ai bambini' },
};
...
export const DIETARY_CAUTION: Record<RoomLocale, string> = {
  ...
  'zh-TW': '我們已排除明顯不符的店家，但仍請您親自向餐廳確認食材。',
