...
export const DINING_COPY: Record<RoomLocale, DiningCopy> = {
  ...
  fr: {
    title: {
      ...
      dinner: 'Dîner près de {spot}',
      snack: 'Une petite faim près de {spot}',
    },
    walk: '{min} min à pied',
    openUntil: 'Ouvert jusqu’à {time}',
    openNow: 'Ouvert actuellement',
    closedToday: 'Fermé en ce moment',
    hoursUnknown: 'Horaires inconnus',
    unrated: 'Pas d’avis disponibles — tri par distance',
    reviews: '{count} avis',
    filteredFor: 'Filtres appliqués',
    goHere: 'On y va',
    reportWrong: 'Signaler une erreur',
    mapLink: 'Kakao Map',
    directions: 'Itinéraire',
    caution: DIETARY_CAUTION.fr,
    empty: 'Rien ne correspond à proximité — parlez-en à votre guide et nous trouverons une adresse.',
  },
  de: {
    title: {
      lunch: 'Mittagessen nahe {spot}',
      dinner: 'Abendessen nahe {spot}',
      snack: 'Kleiner Snack nahe {spot}',
    },
    walk: '{min} Min. zu Fuß',
    openUntil: 'Geöffnet bis {time}',
    openNow: 'Jetzt geöffnet',
    closedToday: 'Derzeit geschlossen',
    hoursUnknown: 'Öffnungszeiten unbekannt',
    unrated: 'Keine Bewertungen vorhanden — nach Entfernung sortiert',
    reviews: '{count} Bewertungen',
    filteredFor: 'Gefiltert nach',
    goHere: 'Hier gehen wir hin',
    reportWrong: 'Fehler melden',
    mapLink: 'Kakao Map',
    directions: 'Route',
    caution: DIETARY_CAUTION.de,
    empty: 'In der Nähe passt nichts — sagen Sie Ihrem Guide Bescheid, wir finden etwas.',
  },
  ru: {
    title: {
      lunch: 'Обед рядом с {spot}',
      dinner: 'Ужин рядом с {spot}',
      snack: 'Перекус рядом с {spot}',
    },
    walk: '{min} мин пешком',
    openUntil: 'Открыто до {time}',
    openNow: 'Открыто сейчас',
    closedToday: 'Сейчас закрыто',
    hoursUnknown: 'Часы работы неизвестны',
    unrated: 'Нет отзывов — сортировка по расстоянию',
    reviews: 'Отзывов: {count}',
    filteredFor: 'Фильтры',
    goHere: 'Идем сюда',
    reportWrong: 'Ошибка в данных',
    mapLink: 'Kakao Map',
    directions: 'Маршрут',
    caution: DIETARY_CAUTION.ru,
    empty: 'Поблизости ничего не подошло — скажите гиду, и мы что-нибудь найдем.',
  },
  it: {
    title: {
      lunch: 'Pranzo vicino a {spot}',
      dinner: 'Cena vicino a {spot}',
      snack: 'Uno spuntino vicino a {spot}',
    },
    walk: '{min} min a piedi',
    openUntil: 'Aperto fino alle {time}',
    openNow: 'Aperto ora',
    closedToday: 'Chiuso al momento',
    hoursUnknown: 'Orari non disponibili',
    unrated: 'Nessuna recensione — ordinato per distanza',
    reviews: '{count} recensioni',
    filteredFor: 'Filtri applicati',
    goHere: 'Andiamo qui',
    reportWrong: 'Segnala un errore',
    mapLink: 'Kakao Map',
    directions: 'Indicazioni',
    caution: DIETARY_CAUTION.it,
    empty: 'Niente di adatto qui vicino — dillo alla tua guida e troveremo qualcosa.',
  },
};
