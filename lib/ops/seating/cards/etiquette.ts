...
const ETIQUETTE_LINES: Array<Record<RoomLocale, string>> = [
  ...
  },
  {
    ...
    'zh-TW': '韓國景區全面禁菸，戶外區域也包含在內 — 罰鍰最高 10 萬韓元。',
  ...
  },
  {
    ...
    'zh-TW': '在寺廟與王陵請放低音量、沿指定路線參觀，拍攝他人前請先徵得同意。',
  ...
  },
  {
    ...
    'zh-TW': '請在螢幕上方倒數結束前回到集合地點 — 全團都會等最後一位。',
  ...
  },
  {
    ...
    'zh-TW': '行駛中請勿與司機交談（道路交通法規）。請改用訊息輸入框裡的一鍵常用語句 — 洗手間、太冷、暈車等都已翻譯好。',
