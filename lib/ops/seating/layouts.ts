...
export const VEHICLE_LAYOUT_SEEDS: Record<VehicleModel, VehicleLayoutSeed> = {
  county_20: {
    ...
    displayName: {
      ...
      fr: 'County 20 places',
      de: 'County 20-Sitzer',
      ru: 'County на 20 мест',
      it: 'County da 20 posti',
    },
    layout: COUNTY_20,
    totalSeats: 20,
  },
  solati_16: {
    ...
    displayName: {
      ...
      ko: '쏠라티 15/16인승 고급',
      zh: 'Solati 15/16座高级',
      'zh-TW': 'Solati 15/16人座高級廂型車',
      es: 'Solati de 15/16 plazas premium',
      ja: 'ソラティ 15/16人乗りプレミアム',
      fr: 'Solati 15/16 places (van premium)',
      de: 'Solati 15/16-Sitzer (Premium-Van)',
      ru: 'Solati на 15/16 мест (премиум-вэн)',
      it: 'Solati da 15/16 posti (van premium)',
    },
    layout: SOLATI_16,
  ...
  limo_27: {
    ...
    displayName: {
      ...
      ja: '27人乗りリムジンバス',
      fr: 'Autocar limousine 27 places',
      de: '27-Sitzer-Limousinenbus',
      ru: 'Автобус-люкс на 27 мест',
      it: 'Pullman limousine da 27 posti',
    },
    layout: LIMO_27,
    totalSeats: 27,
  },
  bus_35: {
    ...
    displayName: {
      ...
      ja: '35人乗り中型バス',
      fr: 'Bus intermédiaire 35 places',
      de: '35-Sitzer-Midibus',
      ru: 'Средний автобус на 35 мест',
      it: 'Midibus da 35 posti',
    },
    layout: BUS_35,
    totalSeats: 35,
  },
  bus_45: {
    ...
    displayName: {
      ...
      ja: '45人乗り大型バス',
      fr: 'Autocar 45 places',
      de: '45-Sitzer-Reisebus',
      ru: 'Автобус на 45 мест',
      it: 'Pullman da 45 posti',
    },
    layout: BUS_45,
    totalSeats: 45,
  },
