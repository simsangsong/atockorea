...
const COPY: Record<JoinCopyKey, Record<RoomLocale, string>> = {
  ...
  pax: { en: '{n} pax', ko: '{n}명', zh: '{n}人', ja: '{n}名', es: '{n} pers.', fr: '{n} pers.', de: '{n} Pers.', ru: '{n} чел.', it: '{n} pers.' },
  claimed: { en: 'registered', ko: '등록됨', zh: '已登记', ja: '登録済み', es: 'registrado', fr: 'enregistré', de: 'registriert', ru: 'зарегистрировано', it: 'registrato' },
  pickName: { en: 'This is me', ko: '본인입니다', zh: '这是我', ja: '本人です', es: 'Soy yo', fr: 'C’est moi', de: 'Das bin ich', ru: 'Это я', it: 'Sono io' },
  verifyTitle: {
  ...
  confirm: { en: 'Confirm', ko: '확인', zh: '确认', ja: '確認', es: 'Confirmar', fr: 'Confirmer', de: 'Bestätigen', ru: 'Подтвердить', it: 'Conferma' },
  back: { en: 'Back', ko: '뒤로', zh: '返回', ja: '戻る', es: 'Atrás', fr: 'Retour', de: 'Zurück', ru: 'Назад', it: 'Indietro' },
  verifyFailed: {
  ...
  yourSeats: { en: 'Your seats', ko: '내 좌석', zh: '您的座位', ja: 'あなたの座席', es: 'Sus asientos', fr: 'Vos sièges', de: 'Ihre Sitzplätze', ru: 'Ваши места', it: 'I tuoi posti' },
  loading: { en: 'Loading…', ko: '불러오는 중…', zh: '加载中…', ja: '読み込み中…', es: 'Cargando…', fr: 'Chargement…', de: 'Wird geladen…', ru: 'Загрузка…', it: 'Caricamento…' },
  error: {
  ...
  retry: { en: 'Try again', ko: '다시 시도', zh: '重试', ja: 'もう一度', es: 'Reintentar', fr: 'Réessayer', de: 'Erneut versuchen', ru: 'Повторить', it: 'Riprova' },
};
