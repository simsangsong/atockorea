...
export const TOUR_WEATHER_ANCHORS: Record<string, TourWeatherAnchor> = {
  ...
  "seoul-gapyeong-nami-morning-calm-petite-france-day-tour": { latitude: 37.7917, longitude: 127.5255, areaLabel: "Nami · Gapyeong", areaLabelKo: "남이섬·가평" },
  "seoul-winter-seoraksan-nami-eobi-ice-valley-day-tour": { latitude: 38.1574, longitude: 128.4355, areaLabel: "Seoraksan · Gangwon", areaLabelKo: "설악산·강원" },
