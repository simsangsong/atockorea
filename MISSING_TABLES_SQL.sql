...
-- ============================================
-- 기존 테이블이 있으면 삭제하지 않고 확인만 함 (데이터 보존)
DO $$
BEGIN
  IF NOT EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'promo_code_usage') THEN
