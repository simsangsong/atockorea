/**
 * Builder checkout loading boundary — the page is a server-dynamic render
 * (quote recompute + session), so this paints a checkout-shaped skeleton
 * immediately instead of a blank frame while the server streams.
 */
export default function BuilderCheckoutLoading() {
  return (
      ...
      <div className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-[1fr_360px]">
          <div className="space-y-4">
            <div className="h-48 w-full animate-pulse rounded-2xl bg-slate-200/60" />
            <div className="h-40 w-full animate-pulse rounded-2xl bg-slate-200/50" />
          </div>
