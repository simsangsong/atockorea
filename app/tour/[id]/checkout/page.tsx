...
export default function CheckoutPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!customerInfo.preferredChatApp.trim()) {
      newErrors.preferredChatApp = 'Please select your preferred chat app';
    }
    if (!customerInfo.chatAppContact.trim()) {
      newErrors.chatAppContact = 'Please enter your chat app contact';
    }
  ...
  const handlePayment = async () => {
    ...
    // Save customer info to booking data
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.08)] border border-gray-200/60 p-6 md:p-8 transition-all hover:shadow-[0_12px_40px_rgba(0,0,0,0.12)]">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-800 mb-2">
                      Preferred Chat App <span className="text-red-500">*</span>
                    </label>
                    <select
                  ...
                  <div>
                    <label className="block text-sm font-semibold text-gray-800 mb-2">
                      Chat App Contact <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
                      ...
                      placeholder="Enter your chat app ID or contact"
                    />
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                  ...
                  {bookingData.paymentMethod === 'deposit' && bookingData.depositAmountUSD && bookingData.balanceAmountKRW && (
                    <div className="mt-4 pt-4 border-t border-gray-200">
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-gray-600">Deposit (USD)</span>
                          <span className="text-sm font-bold text-blue-600">${bookingData.depositAmountUSD.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-sm text-gray-600">Balance (KRW)</span>
                ...
                >
                  ...
                  ) : bookingData.paymentMethod === 'deposit' ? 'Pay Deposit' : 'Complete Booking'}
                </button>
              </div>
            </div>
          </div>
