...
export default function SignUpPage() {
  ...
  const handleSocialLogin = (provider: string) => {
    alert(`${provider} sign up will be implemented`);
  };
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="max-w-md mx-auto">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200/50 p-8">
            ...
            <p className="text-gray-600 text-center mb-8">Create your AtoCKorea account</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 outline-none transition-all ${
