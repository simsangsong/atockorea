...
| **Last commit touching this track** | (pending) — fix(builder): below-map trip card + framed mobile map + 2-up sheet grid + compact chips (post-launch polish; §C 2026-06-23 #2) |
| **Owner** | simsangsong |
| **Reviewers** | — |
