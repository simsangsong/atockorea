...
| **Last commit touching this track** | (pending) — fix(builder): compact chips/native-select cleanup + map focus no-zoom + compact InfoWindow (post-launch polish; §C 2026-06-23) |
| **Owner** | simsangsong |
| **Reviewers** | — |
