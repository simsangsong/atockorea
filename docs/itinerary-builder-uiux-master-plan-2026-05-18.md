...
| F — `CartPanel` + mobile bottom-sheet polish | ✅ complete | 2026-05-18 | 2026-05-18 | (this commit) |
| G — `POIDetailModal` (gallery + type) | ⏸ not started | — | — | — |
