...
| ~~10~~ ➜ | ~~**X9**~~ | **UI/UX 감사 트랙으로 흡수**(2026-08-04, PR #682 머지 — `docs/smartapp-uiux-audit-master-plan-2026-08-03.md` §6). X9→U3 · T0→U2+U3 · T1v2/T3→U9 · T5→U8 · O6→U3+U4. **이 표에 남는 건 X8 · X11 · X19 · R6 뿐** | — |
