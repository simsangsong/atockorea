# Tour Photo Audit — 2026-05-23

## Summary

- Tour slugs scanned: **34**
- Locale docs scanned: **204** (missing: 0)
- Total photo references in JSONs: **9600**
- Unique photo paths: **390**
- Physical files in /public/images/tours: **479**
- POI folders: **61** (sparse ≤1 photo: 5)
- Cross-POI reuse (same image, multiple POI keys/locations): **9**
...
| 2 | `seoraksan-national-park` | 1 | 10 |
| 2 | `naksan-beach` | 1 | 6 |
