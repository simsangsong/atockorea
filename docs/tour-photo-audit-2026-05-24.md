...
- Total photo references in JSONs: **10068**
- Unique photo paths: **392**
- Physical files in /public/images/tours: **479**
- POI folders: **61** (sparse ≤1 photo: 4)
- Cross-POI reuse (same image, multiple POI keys/locations): **10**
- Missing files (referenced but not on disk): **0**
- Orphan files (on disk, never referenced): **106**
...
- `/images/tours/dmz/chatgpt-image-2026-5-10-10-36-43.webp` (folder=`dmz`) used by POI keys [third_infiltration_tunnel, dora_observatory] / locations [3rd Infiltration Tunnel (Underground Invasion Tunnel) | 제3땅굴 (지하 침투 땅굴) | 第3浸透トンネル（地下侵入トンネル）]
- `/images/tours/dmz/chatgpt-image-2026-5-10-10-39-00.webp` (folder=`dmz`) used by POI keys [third_infiltration_tunnel, dora_observatory] / locations [3rd Infiltration Tunnel (Underground Invasion Tunnel) | 제3땅굴 (지하 침투 땅굴) | 第3浸透トンネル（地下侵入トンネル）]
- `/images/tours/dmz/chatgpt-image-2026-5-10-10-40-32.webp` (folder=`dmz`) used by POI keys [third_infiltration_tunnel, dora_observatory] / locations [3rd Infiltration Tunnel (Underground Invasion Tunnel) | 제3땅굴 (지하 침투 땅굴) | 第3浸透トンネル（地下侵入トンネル）]
...
- `/images/tours/jeju-ecoland/chatgpt-image-2026-5-8-07-58-24.webp`
- `/images/tours/jeju-ecoland/chatgpt-image-2026-5-8-08-01-09-2.webp`
...
| 2 | `gamaksan-suspension-bridge` | 1 | 0 |
| 2 | `naksan-beach` | 1 | 6 |
