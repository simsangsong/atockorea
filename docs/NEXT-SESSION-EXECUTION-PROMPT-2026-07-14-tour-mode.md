...
**현재 상태:** **Wave T0 전체 완료(9/9) + Wave T1 사실상 완료(T1.11 ⑧만 T5.1 동반 잔여) + Wave T2 음성 9/9 코드 완료.** E2E(playwright) 신설·통과, 투어룸 스코프 테스트 216+, tsc 0. T0~T2 게이트 도달 → 플래그 OFF PR 갱신 후 다음 = **Wave T3(위치공유·지도, T3.1~T3.7)**. 실기기 음성 체크리스트는 플랜 §I-4(파일럿 전 수행).
