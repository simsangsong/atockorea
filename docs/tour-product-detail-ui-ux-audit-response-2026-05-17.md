...
| **Sprint 5 (정보 과밀 reversal + Apple/Airbnb 럭셔리 미니멀 — §B-P4/P5/P6 가드)** | 🔄 (5.1 ✅ / 5.2 in-progress) | 2026-05-18 | — | 14b6faf2 |
| Sprint 6+ (장기 polish) | 📦 | — | — | — |
...
| 2026-05-18 | Sprint 5.2 started — Included 5 visible + Excluded grid → core 3 + 미리보기 prose + "Show all X" + Excluded inline prose 1줄 + 카드 frame premium (Inner top highlight + hover lift 신규 적용) | (이 커밋) | `TourIncludedSection.tsx`. §B-P6 6조건 적용 — 단조롭게 늘어진 grid wash → editorial card. |
