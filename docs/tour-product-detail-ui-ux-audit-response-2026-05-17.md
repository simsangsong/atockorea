...
| **Sprint 5 (정보 과밀 reversal + Apple/Airbnb 럭셔리 미니멀 — §B-P4/P5/P6 가드)** | 🔄 (5.1-5.7 ✅ + §B-P7/P8/P9/P10 follow-ups / 5.5b ✅ busan-cruise 6 locale + refund/민감사항 가드 / 다른 tour 확장 대기 / 5.8 conditional / **5.9 ✅ pilot (TourBookingSupportSection) + 확장 #1 ✅ Included; 확장 #2-5 (Reviews/Fit/Pickup/Practical) 대기**) | 2026-05-18 | — | (다음 커밋) |
| Sprint 6+ (장기 polish) | 📦 | — | — | — |
