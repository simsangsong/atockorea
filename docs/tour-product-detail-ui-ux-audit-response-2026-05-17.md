...
| **Sprint 5 (정보 과밀 reversal + Apple/Airbnb 럭셔리 미니멀 — §B-P4/P5/P6 가드)** | 🔄 (5.1 ✅ / 5.2 ✅ / 5.3 ready) | 2026-05-18 | — | c8161466 |
| Sprint 6+ (장기 polish) | 📦 | — | — | — |
...
| 2026-05-18 | Sprint 5.3 started — Pickup notes inline → per-row underlined "Details" reveal (note 있는 row만 button, default closed) + 닫힌 row 자체가 4-layer hierarchy preview | (이 커밋) | `TourPickupDropoffSection.tsx`. 5.1 reveal pattern을 row-level로 확장. |
