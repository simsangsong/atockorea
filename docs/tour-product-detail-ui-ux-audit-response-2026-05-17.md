...
| **Sprint 5 (정보 과밀 reversal + Apple/Airbnb 럭셔리 미니멀 — §B-P4/P5/P6 가드)** | 🔄 (5.1-5.7 ✅ + §B-P7/P8/P9/P10 follow-ups / 5.5b ✅ busan-cruise 6 locale + refund/민감사항 가드 / 다른 tour 확장 대기 / 5.8 conditional / **5.9 🔄 §B-P11 book-page cascade reveal 플랜만 박힘 — pilot 코드 미실행**) | 2026-05-18 | — | 0d8fa801 |
| Sprint 6+ (장기 polish) | 📦 | — | — | — |
