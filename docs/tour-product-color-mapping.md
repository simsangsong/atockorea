...
| 섹션 캔버스 | `--section-warm` `#faf7f3` · `--section-alt` `#f3f3f5` | **캔버스 값(장식 아님)**. 긴 스크롤에서 흰 섹션이 연달아 나오면 한 장의 백지로 읽혀 피로해진다 → 본문 구간은 white↔warm 교대, 마감 구간(리뷰·추천)은 alt. warm 은 copper 에디토리얼 존과 같은 온도. `--tpc-*` 밴드 규칙 대상 아님 |
