...
- **T3-4 완료 (PR #426):** 운영자 상황 프리셋 `operatorPresets.ts`(8종 5로케일 zero-LLM: 따라오세요/여기서 표 사세요/대기/탑승/출발/휴식/사진/다 함께)+broadcast `operatorPresetKey` 팬아웃+GuideConsole 원탭 전송.
- **TIER 3 잔여(사람 게이트):** T3-1 비디오·T3-2 다국어 스팟오디오·T3-3 지역개요 = 콘텐츠 제작+콘텐츠모델 결정 필요(스캐폴딩은 투기적). T3-5 핀 other kind = facility-pins 병렬세션 영역이라 회피.
- **세션 종합(2026-07-20): 코드 트랙 TIER 0·1·2 + T3-4 완료 = 10 PR(#417~#426).** 핵심 실사용 갭(통역 신뢰성·프라이빗 정산·버스 운영자 도달·운영자 프리셋) 전부 해소. 남은 건 콘텐츠 제작·실기기 QA·플래그 ON = 사람 게이트.
