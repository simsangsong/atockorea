...
| 행위자 | guest 43 · guide 7 · driver 2 · admin 2 |
...
| `GET` | `/api/tour-rooms/[bookingId]/arrival-bundle` | guest | free | 7 |  |
| `GET` | `/api/tour-rooms/[bookingId]/companion-invite` | guest | free | 8 |  |
| `GET` | `/api/tour-rooms/[bookingId]/day-summary` | guest | free | 9 |  |
...
| `POST` | `/api/tour-rooms/[bookingId]/captions` | guest | llm | 6 |  |
...
| `POST` | `/api/tour-rooms/[bookingId]/morning-briefing` | guest | llm | 19 |  |
