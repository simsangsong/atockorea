...
**총 84개** · 회귀: `__tests__/audit/a1Coverage.test.ts`
**진행:** ✅ **84/84 전량 감사 완료** (A1 소관 65 + A2 운영자면 10 + P7 신규 2 + SG 신규 4). 산출물 `A1-1`~`A1-8` · `A2-1-2-operator-faces.md` · `A2-4-permission-matrix.md`
