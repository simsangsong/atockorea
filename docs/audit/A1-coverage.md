...
**진행:** A1.1 완료(6/65) · 산출물 `docs/audit/A1-1-chat-core.md`
...
| 파일 | 티켓 | 판정 |
|---|---|---|
| `plan/PlanEditorClient.tsx` | A1.5 | ⬜ |
| `plan/PlanStopCards.tsx` | A1.5 | ⬜ |
