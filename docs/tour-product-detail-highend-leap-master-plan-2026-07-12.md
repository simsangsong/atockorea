...
| 2026-07-14 | **W1.7 드로어 drag handle + swipe-down dismiss** — useDragControls(핸들에서만 드래그 시작, 내부 스크롤 보존), offset>72px 또는 velocity>600 시 dismiss, 4슬러그 확인. 빌드: JS union gz **+0.5KB**(493.1→493.6, 한도 5KB), ISR 유지. 요소 대차대조표: +1(grab handle) | (W1.3 PR) | P-LOW |
