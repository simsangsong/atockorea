...
| **Blocked on** | — |
| **Last updated** | 2026-06-23 — **Builder refinement track (Phase A–D, D41–D44) started; Phase A ✅ shipped** (사진없는 POI 숨김 + 동선 60% 경고). ⚠ §A의 "Phase 13" 이후 PR #110(빌더 de-AI)·홈 reform은 이 doc에 미반영 — 코드 실사 우선. |
