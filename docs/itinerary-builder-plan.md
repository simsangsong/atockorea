...
| **Last commit touching this feature** | `514083d8` — feat(admin): Phase 10.6b — builder cancellation email + inventory NULL-tour guard. Phase 6 complete: `/admin/orders` source filter, all booking surfaces currency-aware (formatBookingPrice helper), builder cancellation parity restored. |
| **Owner** | simsangsong |
| **Reviewers** | — |
