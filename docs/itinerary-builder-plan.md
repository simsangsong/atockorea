...
| **Blocked on** | — |
| **Last updated** | 2026-06-23 — **Builder refinement track (Phase A–D, D41–D44) ✅ COMPLETE** (A=사진숨김+동선60%경고 / B=AI추천 재활성화 / C=지역 묶음 / D=제주 추가요금 East-aware+캡10만). 선택 후속=Phase D.2(구글맵 호텔 자동판정). ⚠ §A의 "Phase 13" 이후 PR #110(빌더 de-AI)·홈 reform은 이 doc에 미반영 — 코드 실사 우선. |
