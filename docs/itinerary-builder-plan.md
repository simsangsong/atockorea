...
| **Last commit touching this feature** | `51a27c2d` — feat(builder): Phase 10.4 auto-run AI recommendation + cart adoption (debounce 500ms · cap 3/session · "Take this itinerary" CTA removed · 4 telemetry events · -hours select duplicate) |
| **Owner** | simsangsong |
| **Reviewers** | — |
