...
| **Blocked on** | — |
| **Last updated** | 2026-06-23 — **Builder refinement track (Phase A–D, D41–D44): Phase A ✅ + Phase B ✅ shipped** (A=사진없는 POI 숨김+동선 60% 경고 / B="AI 추천받기" 재활성화). 다음=Phase C(지역 묶음, 서울 gyeonggi 재태깅 선행). ⚠ §A의 "Phase 13" 이후 PR #110(빌더 de-AI)·홈 reform은 이 doc에 미반영 — 코드 실사 우선. |
