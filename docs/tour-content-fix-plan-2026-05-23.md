...
| **5b residual (Haenyeo demo timing 14:00 → 13:30/15:00)** | (this commit) | (this commit) | Closes Haenyeo demo timing deferred item. External verification (VisitKorea official: twice daily at 13:30–14:30 and 15:00–16:00 — NOT once at 14:00). Internal reasoning notes already correct (13:30/15:00); customer-facing bullets were wrong. 56 swaps across 7 affected slugs × 6 locales (jeju-cruise bus + small-group, jeju-cherry-east, jeju-hydrangea-east, jeju-eastern-unesco, jeju-grand-highlights-loop, east-signature) + 1 component (`_shared/HaenyeoStatusButton.tsx` SECTION_SUBHEAD × 6 locales) + 4 ES variant follow-ups. Universal EN needle pass against all locale files (EN source citations duplicated across non-EN bundles). Phase Z extended with 2 new guards (`once daily at 14:00`, `once daily at 14:00 (1 show/day)`). `scripts/phase-haenyeo-time-sweep.mjs`. |
