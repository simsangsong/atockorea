...
| 5b EN | 수치 정정 (verify 필요 항목) | 중 | ~10 항목 × tours | ✅ mostly shipped 2026-05-23 — Camellia Hill ₩12,000 + Morning Calm 20 gardens + Jewel in the Palace 50M→peak ~57% MBC (PR #45) + Waujeongsa founder/Buddha/bell consistency (Kim Hae Geun / 12m×3m Indonesian juniper / 12-ton Bell of Unification 1988 Olympics) across 6 locales + Hwaseong UNESCO Uigwe inscription expansion across 6 locales (this commit); only Bomun cherry count / Haenyeo demo time still deferred (source ambiguity) |
| 6 EN | 갤러리 사진-지명 재매핑 | 중 | ~9 tours × galleryItems | ✅ shipped 2026-05-23 (this commit) — full 6-locale sweep, 2,057 items rewritten (EN 201 + ko 400 + ja 533 + zh 361 + zh-TW 389 + es 173) via canonical POI map driven by src folder name |
...
| 1b–f / 2b–f / 4b–f / 5 locales | 잔여 locale 동기화 | 낮음-중 | ~50 files | ✅ shipped 2026-05-23 (this commit) — multi-locale Phase Z audit reports 0 offenders across all 6 locales; only residuals are correction-citation false positives (legitimate explanatory copy) |
...
| **locale-residual sweep (1b–f / 2b–f / 4b–f follow-up + Silla Gold Crowns past-tense + Bukchon EN 600→900)** | (this commit) | (this commit) | ① **Bukchon "≈600 hanoks" → "≈900 hanoks"** in 2 EN-only instances (`from-incheon-seoul-day-tour-cruise-guests.en.json` FAQ Q/A at L992 + L2045; all non-EN locales already at 900 from earlier loc-B PR — this catches the EN outlier). ② **Silla Gold Crowns "Power and Prestige" special exhibition past-tense rewrite** across all 6 locales × 3 instances per locale = 18 surgical swaps in `busan-gyeongju-unesco-legacy-tour-national-museum/*.json`. The exhibition ran Oct 28 - Dec 14, 2025 (APEC commemoration); today is May 2026 so the "running through / current major / 까지 / まで開催 / 持续至 / hasta el" present-tense framing is factually wrong. Rewrote to past tense + appended closing sentence "today the Cheonmachong gold crown remains the permanent Silla Hall centerpiece" in 6 locales (현재 천마총 금관은 상설 신라역사관의 중심 전시품 / 現在は天馬塚金冠が常設の新羅館を代表する展示品 / 目前天马冢金冠仍为常设新罗馆的核心展品 / 目前天馬塚金冠仍為常設新羅館的核心展品 / actualmente la Corona de Oro de Cheonmachong sigue siendo la pieza central permanente de la Sala Silla). Plus audit improvements (added English/Spanish correction-citation exclude patterns "operator sources cite" / "operadores citan" / "Majangho conflation" / "confunde este puente"). Multi-locale Phase Z audit now reports **0 offenders across all 6 locales**. `scripts/phase-locale-residual-audit.mjs` + `scripts/phase-loc-residual-sweep.mjs`. |
| **6 (gallery attribution sweep, all 6 locales)** | (this commit) | (this commit) | **2,057 galleryItems rewritten across 6 locales × 34 tour bundles** to bring `location/caption/alt` into alignment with the `src` filename (the authoritative attribution per `reference_atoc_photo_import_pipeline`). Per-locale: en +201, ko +400, ja +533, zh +361, zh-TW +389, es +173 (locale variation explained by larger non-EN locales having pre-existing higher orphan attribution counts and the EN bundle having received earlier cleanup in `phase6-gallery-en-cleanup.mjs`). Canonical POI map covers 34 source folders (ilchulland → Ilchul Land / 일출랜드 / イルチュルランド / 日出乐园 / 日出樂園, seongsan-ilchulbong → Seongsan Ilchulbong / 성산일출봉 / 城山日出峰, taejongdae → Taejongdae Park, osulloc-tea → O'sulloc Tea Museum, un-memorial-cemetery, gyeongbokgung, jusangjeolli, cheonjeyeon-falls, jeju-stone-park, cheomseongdae, seongeup-folk-village, gyochon-hanok-village, bulguksa-temple, hallasan-eoseungsaengak, sanjeong-lake, imjingak, nami-island, suwon-hwaseong, starfield-library-suwon, gyeongju-national-museum, busan-tower, cheongsapo-blue-line, jeongbang-falls, camellia-hill, hallasan-1100, gamcheon-culture-village, seopjikoji, gwangjang-market, jeju-haenyeo-museum, hyeopjae-beach, waujeongsa, aewol-cafe-street, hamdeok-beach + dmz umbrella w/ 3rd-tunnel/dora/imjingak/gamaksan aliases). Caption photo-number preservation: trailing "— photo N" / "— 사진 N" suffix kept iff the original caption explicitly had it (narrow regex, no fallback to filename digits to avoid timestamp leakage). Audit-after: **0 mismatch candidates** (down from 213 pre-improvement → 159 post-improvement → 0 post-fix). `scripts/phase-6-attribution-audit.mjs` (umbrella-aware + substring fallback) + `scripts/phase-6-attribution-fix.mjs` (canonical map + smart photo-number preservation). |
...
| **5b residual (Waujeongsa multi-locale consistency + Hwaseong Uigwe expansion)** | (this commit) | (this commit) | ① **Waujeongsa** Section-1↔Section-2 reconciliation across 6 locales × 7-11 needles per locale (52 swaps total): founder Master Haedeung → Kim Hae Geun (per Visit Korea official + Wikipedia/Travel-Stained); reclining Buddha 3m sandalwood → 12m × 3m Indonesian juniper (Wabul, Guinness World Records); bell Taepyeongjong 8-ton → Bell of Unification 12-ton (rung at 1988 Seoul Olympics per multiple sources); EN-only Section-2 mountain "Mount Eunesan foothills" → "Yeonhwasan (Lotus Flower Mountain) foothills" to unify with Section-1 etymology link (Wau = "reclining cow" matches Yeonhwasan topography per Visit Korea). External fact verification via VisitKorea + Travel-Stained + Lily by Lily blog + Wikipedia. ② **Hwaseong UNESCO Uigwe inscription expansion** in `seoul-suwon-hwaseong-gwangmyeong-cave-starfield-library` L293 across 6 locales (the highlight bullet wasn't expanded the way the folk-village slug's L269 was). EN: "Korea's only walled fortress city" → "Korea's only walled fortress city with original construction records"; locales append Uigwe-specific detail ("(원본 화성성역의궤 공사 기록 보유)", "（華城城役儀軌の原本工事記録あり）", etc.). `scripts/phase-5b-waujeongsa-sweep.mjs`. Multi-locale Phase Z audit: 0 offenders. |
| **pocheon-sanjeong cancellation policy** | (this commit) | (this commit) | Appended canonical `cancellation` accordion item to `$.practicalAccordionItems` array of pocheon-sanjeong-lake-herb-island-art-valley in all 6 locales (was missing entirely; other tours in the catalog like seoul-suwon-hwaseong-folk-village carry the same item). Standard 2-line policy: "Free cancellation up to 24 hours before the tour starts. / Same-day cancellations and no-shows are non-refundable." with locale-translated titles ("취소 규정" / "キャンセルについて" / "取消政策" / "Cancelación"). Top-level array only — legacy `page_sections[7].props.practicalAccordionItems` not edited per `reference_tour_product_render_source`. `scripts/phase-7-pocheon-sanjeong-cancellation-add.mjs`. |
| **audit-P0 #1 (jeju cruise pickup_dropoff DB+static sync)** | (this commit) | (this commit) | Closes audit P0 #1 from `tour-product-en-post-merge-audit-2026-05-23.md`. ① **DB**: 12 `tour_product_pages.detail_payload.pickup_dropoff` rows (2 cruise slugs × 6 locales) updated via Supabase MCP from stale hotel/airport (Ocean Suites Jeju / Jeju International Airport / LOTTE City / Shilla Duty Free / Dongmun) to canonical 2 cruise terminals (Jeju International Passenger Terminal 제주항 33.5286,126.5868 + Gangjeong Civil-Military Cruise Terminal 강정항 33.2247,126.5512). ② **Static JSON**: 8 stale/missing locale files brought up to canonical (ko/ja/zh bus-tour were stale; ko/ja/zh/zh-TW/es small-group-tour had no `pickup_dropoff` field at all). EN/zh-TW/es bus-tour static was already canonical and unchanged. ③ Per-locale hand-translated terminal names, pickup notes, and the closing sail-away-buffer notes paragraph — matched to zh-TW/es style with parenthetical Korean (제주항 / 강정항) preserved for proper-noun recognition. Audit verification: post-apply DB query confirms first_pickup_type='cruise_terminal' for all 12 rows. `scripts/phase-cruise-pickup-canonicalize.mjs` + `scripts/phase-cruise-pickup-db-updates.sql`. |
| **P1 typo sweep (audit P1 #4 잔여 5건)** | (this commit) | (this commit) | Closes audit P1 #4 remaining typo backlog. Surgical needle/replace × 14 swaps across 11 files: ① "route route option" → "route option" (4 instances × 2 jeju cruise EN bundles, 2 each), ② "hard day-schedule schedule limit" → "hard day-schedule limit" + "hard schedule schedule limit" → "hard schedule limit" (2 instances jeju-winter EN), ③ "small-group group dynamics" → "small-group dynamics" (1 instance seoraksan-sokcho EN), ④ "1100 Road road-closure note" → "1100 Road closure note" (1 instance southwest-hallasan EN), ⑤ "Visit Korea Korea Foundation Cultural Heritage Bridges Series" → "Korea Foundation Cultural Heritage Bridges Series" (org-name conflation; 6 instances seoul-dmz × 6 locales — source citation kept in EN across all locales). Phase Z extended with 5 new needles to block regression: "route route option", "schedule schedule", "small-group group", "1100 Road road-closure", "Visit Korea Korea Foundation". `scripts/phase-p1-typo-sweep.mjs`. |
| **audit-P1 #5 (jeju cruise included title honest rewrite)** | (this commit) | (this commit) | Closes audit P1 #5. Schema already supports ✓/✗ visual split via `variant: "included"` + `includedCount: 5` (rendering code in `_shared`/`east-signature-nature-core/tour-detail-sections/TourIncludedSection.tsx` + `TourPracticalDetails.tsx`), so no structural change required — items past index 5 already render with the muted ✗ glyph. Issue was the section title + preview implied everything was included. Renamed across 6 locales × 2 cruise slugs (12 files): title "What's included" → "Included / Not included" (locale-localized: "포함 / 불포함" / "含まれるもの / 含まれないもの" / "包含 / 不包含" / "Incluido / No incluido"); preview extended to mention own-expense items ("lunch / shopping / tips own expense"). Also pinned `includedCount: 5` explicitly so future content additions don't silently shift the ✓/✗ boundary. `scripts/phase-p1-cruise-included-honest.mjs`. |
| **audit-P1 #6 (vehicle price type — 9 sites)** | (this commit) | (this commit) | Closes audit P1 #6. Extends type unions `'person' \| 'group'` → `'person' \| 'group' \| 'vehicle'` across 9 admin/types/list/cart sites: `lib/admin/tour-write-rules.ts` (PRICE_TYPES const + docstring), `app/api/admin/tours/route.ts` (CREATE validator + error msg + comment), `lib/supabase.ts` (Database row type), `lib/db-relations.ts` (TourRelation interface), `app/api/cart/[id]/route.ts` (relation cast + comment that 'group' and 'vehicle' both yield flat per-booking pricing), `components/TourCard.tsx` (priceType prop), `components/TourList.tsx` (price_type prop), `components/SeasonalTours.tsx` (price_type prop), `components/tours/DetailedTourCard.tsx` (priceType prop). Cart's `totalPrice = priceType === 'person' ? unit*guests : unit` branch already correct for vehicle (flat) — only TS annotation was over-narrow. Display renders `/{priceType}` which becomes `/vehicle` for vehicle products (semantically "per vehicle"). Earlier Phase C (PR #17) had extended `eastSignatureCheckoutContext.ts`; this catches the 9 remaining stale admin/list/cart sites. |
| **5b residual (Haenyeo demo timing 14:00 → 13:30/15:00)** | (this commit) | (this commit) | Closes Haenyeo demo timing deferred item. ⚠ **SUPERSEDED by next row** — external VisitKorea info was stale; operator-confirmed ground truth (2026-05-24) is once daily at 14:00 only. See next row for revert. |
| **5b residual REVERT (Haenyeo: 14:00 1회 only — operator ground truth)** | (this commit) | (this commit) | Operator-confirmed (2026-05-24): the Haenyeo performance at Seongsan currently runs **once daily at 14:00 only**. External tourism sites (VisitKorea English, UME Travel, etc.) carry stale "13:30 + 15:00 twice daily" info. This revert closes that misalignment + also cleans up pre-existing "13:30/15:00" references that lived in the data BEFORE the prior PR #55 (description bodies, FAQ answers, reasoning notes that the previous sweep didn't touch). Two-pass cleanup: ① specific needle table covering ~28 long-form phrasings (highlight + timeUsed bullets) across all 6 locales × 7 affected slugs (47 swaps applied first pass); ② per-string-value regex sweep with guarded scope (only strings containing BOTH a Haenyeo keyword AND a 13:30/15:00 token get rewritten, so unrelated 13:30/15:00 mentions like lunch service windows are untouched) — 38 files rewritten in pass 2; ③ universal EN-needle pass against all locale files (EN source citations duplicated across non-EN bundles); ④ `_shared/HaenyeoStatusButton.tsx` SECTION_SUBHEAD reverted to "once daily at 14:00" copy in all 6 locales. Tight residual scan (Haenyeo ↔ 13:30/15:00 within 80 chars) = **0** across all 34 tour bundles after both passes. Phase Z guards rewritten: previous "once daily at 14:00" guards REMOVED (that's now the canonical) + 8 new guards block stale twice-daily phrasings ("13:30 and 15:00", "13:30과 15:00", "13:30と15:00", "13:30和15:00", "13:30及15:00", "13:30 y 15:00", "13:30 + 15:00", "13:30/15:00"). `scripts/phase-haenyeo-revert-to-14-once.mjs` + `scripts/phase-haenyeo-revert-pass2-regex.mjs`. |
| **temporal language refresh ("recently" → explicit dates)** | (this commit) | (this commit) | Replaces time-relative "recently" with explicit dates across 6 locales × multiple slugs (16+ files / 63 swaps total across 2 passes). Two facts hardened: ① **Seoraksan National Park entrance fee** (3,500 KRW) — "recently abolished" → "abolished May 2023" (confirmed via tripadvisor + multiple sources). Affected slugs: seoul-seoraksan-nami-island-morning-calm-day-tour, seoul-seoraksan-naksansa-temple-naksan-beach-day-trip, seoul-seoraksan-national-park-sokcho-beach-day-trip. ② **HICO Convention Center 2025 APEC Summit** — "recent international milestone" → "2025 international milestone" (the year IS the marker). Affected slugs: busan-spring-cherry-blossom-gyeongju-highlights-day-tour, busan-plum-cherry-blossom-day-tour-to-yangsan-gyeongju. Intentionally skipped (state vs time): "the most recent Jeju coastal NM" (means "newest", factually accurate), "recent winters" (general temporal context, accurate), and ZH "最近的" meaning "nearest"/"closest". Residual scan: 0 across all tour bundles. `scripts/phase-recently-temporal-sweep.mjs`. |
| **schedule arithmetic precision fix (audit deferred)** | (this commit) | (this commit) | Closes audit doc's deferred "schedule arithmetic" item. ① **seoul-seoraksan-nami-island-morning-calm-day-tour** lunch timing inconsistency: Seoraksan itineraryStop documents 180 min (3 hours) starting ≈10:00 ending ≈13:00, but lunch references claim "around 12:30 en route from Seoraksan to Nami" — impossible. Shifted all 22 lunch-timing references across 6 locales from "12:30" → "13:30" (and "12:00-12:30" snack range → "13:00-13:30"). Drive math now works: Seoraksan 13:00 + 30-min restaurant + 1h drive → Nami 14:30 ✓. ② **jeju-cherry-blossom-tour-east-route** Ilchul→Seongsan zero-minute gap fix: Ilchul Land Themed Gardens ends 16:15 → Seongsan Ilchulbong was set to start 16:15 (0 min drive), but Ilchul→Seongsan is ~15 min by car. Pushed Seongsan time field from 16:15 to 16:30 across 6 locales (`itineraryStops` walker, not text replacement). Day end shifts from 17:30 → 17:45, still well before spring sunset. Final 12:30 residual scan: 0 across both slugs. `scripts/phase-schedule-arithmetic-fix.mjs`. |
| 5b EN deferred (Bomun) | — | — | ⏳ |
