...
${termLines || '  (해당 없음)'}
${retry}
## 숫자 — 규칙 3의 구체형 (실측된 탈락 사유)
아래는 뜻이 같아도 **탈락**한다. 숫자는 아라비아 숫자 그대로 남겨라.
  - 연대 축약 금지: \`1970s-1980s\` → \`anni '70-'80\` (❌ 1970·1980이 사라진다)
  - 관용구 치환 금지: \`24/7\` → \`круглосуточно\` (❌ 24가 사라진다)
  - 통화 기호 유지: \`₩70,000\` · \`KRW\` · \`$\` 를 단어로 바꾸지 마라
  - 단위 변환 금지: km·m·m²를 마일·피트·에이커로 바꾸지 마라
